...
This project is indexed by GitNexus as **DealSignal** (10940 symbols, 22028 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
