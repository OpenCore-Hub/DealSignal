...
This project is indexed by GitNexus as **DealSignal** (18415 symbols, 42529 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
