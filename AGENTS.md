...
This project is indexed by GitNexus as **DealSignal** (10528 symbols, 21025 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
