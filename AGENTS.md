...
This project is indexed by GitNexus as **DealSignal** (19217 symbols, 45027 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
