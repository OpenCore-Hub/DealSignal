...
This project is indexed by GitNexus as **DealSignal** (29167 symbols, 81395 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
