...
This project is indexed by GitNexus as **DealSignal** (18908 symbols, 44001 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
