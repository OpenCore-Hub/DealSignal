...
This project is indexed by GitNexus as **DealSignal** (14841 symbols, 32542 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
