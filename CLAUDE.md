...
This project is indexed by GitNexus as **DealSignal** (14888 symbols, 32651 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
