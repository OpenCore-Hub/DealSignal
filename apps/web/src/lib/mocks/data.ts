...
export const mockLinkAccessRequests: LinkAccessRequest[] = [
  ...
  },
  {
    ...
    reason: "Need access via the data room share link",
    status: "pending",
...
export const mockActionItems: ActionItem[] = [
  ...
  },
  {
    ...
    targetId: "room_1",
    title: "Approve data room share access from room-share-applicant@example.com for Acme Seed Data Room",
    impact: "high",
        ...
        action.sourceType === "deal_room_link_access_request"
          ...
          : action.sourceType === "room_nda"
            ...
            : action.sourceType === "room_access_request" ||
                action.sourceType === "expiring_room"
              ? action.sourceId
              : undefined,
      linkId:
        action.sourceType === "expiring_room"
          ? undefined
          : signal?.linkId || action.sourceId,
