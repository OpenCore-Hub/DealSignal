      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={config.passwordEnabled ? "" : "text-muted-foreground"}>{t("creator.featurePassword")}</span>
          </div>
          <div className="flex items-center gap-2">
            <Shield size={16} className={config.watermarkEnabled ? "text-success-500" : "text-muted-foreground"} />
            <span className={config.watermarkEnabled ? "" : "text-muted-foreground"}>{t("creator.featureWatermark")}</span>
          </div>
          <div className="flex items-center gap-2">
            <Warning size={16} className={!config.allowDownload ? "text-success-500" : "text-muted-foreground"} />
            <span className={!config.allowDownload ? "" : "text-muted-foreground"}>{t("creator.featureNoDownload")}</span>
          </div>
        </div>
