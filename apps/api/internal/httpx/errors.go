...
var clientFallbacks = map[string]string{
	...
	"document_exists":                    "a document with this filename already exists",
	"document_exists_outside_room":       "this document is already in another live data room",
	...
	"nda_consent_required":               "nda consent is required",
	"nda_content_mismatch":               "nda content does not match",
	"nda_preview_unavailable":            "nda preview is unavailable",
