-- ArchiveLink / RenewLink emit link_archived / link_renewed security events.
-- Those types were never added to security_events_event_type_check, so inserts
-- failed 23514 (logged) and could abort ambient transactions.
...
BEGIN
  FOR r IN
    ...
    WHERE c.contype = 'c'
      ...
      AND pg_get_constraintdef(c.oid) NOT LIKE '%link_archived%'
  LOOP
