-- Remove the split event type and restore the Phase C allow-list.

DELETE FROM security_events
WHERE event_type = 'session_security_config_changed';
...
BEGIN
  FOR r IN
    ...
    WHERE c.contype = 'c'
      ...
      AND pg_get_constraintdef(c.oid) LIKE '%session_security_config_changed%'
  LOOP
